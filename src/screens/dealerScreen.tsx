...
export default function DealerScreen() {
    ...
    return <div className={'space-y-24 pt-8 pb-24'}>
        ...
        <NewDealers/>
        <PopularDealers/>
        <div className={'mx-auto max-w-5xl p-24 aspect-20/8 rounded-lg glass-card shadow-md border-0! bg-linear-to-br from-primary to-primary/40 dark:to-black flex flex-col justify-center items-center space-y-6'}>
